...
namespace MathParserTK
{
    ...
    public class MathParser
    {
        ...
        public double Parse(string expression, bool isRadians = true, DivisionType divisionType = DivisionType.Float) {
            this.isRadians = isRadians;

            try {
                return Calculate(ConvertToRPN(FormatString(expression)), divisionType);
            }
        ...
        /// <returns>Result</returns>
        private double Calculate(string expression, DivisionType divisionType) {
            int pos = 0; // Current position of lexical analysis
            ...
            while (pos < expression.Length) {
                ...
                stack = SyntaxAnalysisRPN(stack, token, divisionType);
            }
        ...
        private Stack<double> SyntaxAnalysisRPN(Stack<double> stack, string token, DivisionType divisionType) {
            ...
            // Otherwise apply operator or function to elements in stack
                ...
                switch (token) {
                    ...
                    case Divide:
                        ...
                        switch (divisionType) {
                            case DivisionType.Float:
                                rst = arg1 / arg2;
                                break;
                            case DivisionType.OnlyQuotient:
                                rst = (int)(arg1 / arg2);
                                break;
                            case DivisionType.RoundToInt:
                                rst = Math.Round(arg1 / arg2);
                                break;
                            case DivisionType.FloorToInt:
                                rst = Math.Floor(arg1 / arg2);
                                break;
                            case DivisionType.CeilToInt:
                                rst = Math.Ceiling(arg1 / arg2);
                                break;
                            default:
                                rst = 0;
                                break;
